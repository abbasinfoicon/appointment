              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-md-3 form-group">
                    ...
                    <input type="text" name='id' defaultValue={data.id} className="form-control" disabled readOnly />
                  </div>

                  <div className="col-md-3 form-group">
                    <label className="form-label">Email *</label>
                    <input type="email" name='email' defaultValue={data.email} className="form-control" placeholder="Enter Email ID" disabled readOnly />
                  </div>
                </div>
